...
[Embed(source="/net/vicp/madz/assets/backgrounds.swf#bluestripe")]
public var bluestripe:Class;

[Embed(source="/net/vicp/madz/assets/brushedMetal.jpg")]
public var brushedmetal:Class;

[Embed(source="/net/vicp/madz/assets/backgrounds.swf#greenstripe")]
public var greenstripe:Class;

[Embed(source="/net/vicp/madz/assets/backgrounds.swf#industrial")]
public var industrial:Class;

[Embed(source="/net/vicp/madz/assets/backgrounds.swf#redstripe")]
public var redstripe:Class;

[Embed(source="/net/vicp/madz/assets/backgrounds.swf#retroFifties")]
public var retroFifties:Class;

[Embed(source="/net/vicp/madz/assets/backgrounds.swf#tartan")]
...
public function changeBackgroundImage(e:Event):void {
	FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("mx.core.Application").setStyle('backgroundImage', mybackgroundImageapplication.selectedItem.data);
