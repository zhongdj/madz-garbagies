...
//					}
		...
		plantsCollection.add(new DefaultMixingPlantDisplayable("1∫≈Ω¡∞Ë’æ"));
		plantsCollection.add(new DefaultMixingPlantDisplayable("2∫≈Ω¡∞Ë’æ"));
		plantsCollection.add(new DefaultMixingPlantDisplayable("3∫≈Ω¡∞Ë’æ"));
		plantsCollection.add(new DefaultMixingPlantDisplayable("4∫≈Ω¡∞Ë’æ"));
