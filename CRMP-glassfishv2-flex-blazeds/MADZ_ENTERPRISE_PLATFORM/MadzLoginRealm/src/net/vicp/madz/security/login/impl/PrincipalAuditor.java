...
import net.vicp.madz.security.login.interfaces.IPrincipal;
...
public class PrincipalAuditor implements IPrincipalAuditor {
	...
	public boolean auditPassword(String password) throws PasswordException {
		// chech whether the password matches the length requirement
	 ...
	 * @throws net.vicp.madz.security.login.exception.UserNotExistException
	 * @throws net.vicp.madz.security.login.exception.UserLockedException
