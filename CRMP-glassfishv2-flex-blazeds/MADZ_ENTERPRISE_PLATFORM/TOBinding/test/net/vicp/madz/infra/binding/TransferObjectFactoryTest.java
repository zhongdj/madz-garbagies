...
public class TransferObjectFactoryTest {
	...
	public void testCreateTransferObject_WithSimpleBOSimpleTOClass() {
		...
		try {
			bizObject.id = 1L;
			bizObject.name = "BarryPig";
			bizObject.location = "Beijing";
			bizObject.description = "BarryPig is short for Barry is a pig";
	...
	public void testCreateTransferObject_WithSimpleTOFieldsNotInSimpleBOFields() {
		...
		bizObject.id = 1L;
		expectedTO.name = bizObject.name = "BarryPig";
		expectedTO.location = bizObject.location = "Beijing";
		expectedTO.description = bizObject.description = "BarryPig is short for Barry is a pig.";
	...
	public void testAssembleCompositeListValueTO() {
		...
		try {
			ParentWithListChildrenTO actualResult = TransferObjectFactory.createTransferObject(ParentWithListChildrenTO.class, p);
	...
	public void testAssembleCompositeSetValueTO() {
		...
		try {
			ParentWithSetChildrenTO actualResult = TransferObjectFactory.createTransferObject(ParentWithSetChildrenTO.class, p);
			assert (actualResult.children.size() == 3);
	...
	public static class ParentWithSetChildrenPropertyAccessTO {
		protected String name;
		@Binding(bindingType = BindingTypeEnum.Entity, embeddedType = ChildTO.class, accessType = AccessTypeEnum.Property)
		protected Set<ChildTO> children;
	}
}
