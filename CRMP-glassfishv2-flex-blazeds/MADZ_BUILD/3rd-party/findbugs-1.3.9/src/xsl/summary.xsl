...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			<!-- JEditorPane gets really angry if it sees this WWP: Sorry, this needs 
				to be explained better. Not a valid HTML document without a head. -->
			<head>
				<title>
			...
			<body>
				...
				<p align="center">
					...
					<font face="{$PAGE.FONT}" size="4">
						<i>
							(
							<xsl:value-of select="$PACKAGE.SORT.LABEL" />
							)
						</i>
					</font>
				</p>
