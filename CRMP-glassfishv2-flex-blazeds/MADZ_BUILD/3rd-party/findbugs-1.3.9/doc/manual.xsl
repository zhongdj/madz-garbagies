...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- This causes the stylesheet to put chapters in a single HTML file, rather 
		than putting individual sections into seperate files. -->
	<xsl:variable name="chunk.section.depth">
		0
	</xsl:variable>

	<!-- Put the HTML in the "manual" directory. -->
	<xsl:variable name="base.dir">
		manual/
	</xsl:variable>

	<!-- Enumerate sections. -->
	<xsl:variable name="section.autolabel">
		1
	</xsl:variable>
	...
	<xsl:variable name="admon.graphics">
		1
	</xsl:variable>
	...
	<xsl:variable name="toc.section.depth">
		1
	</xsl:variable>
